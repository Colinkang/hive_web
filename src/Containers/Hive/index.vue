...
<div class="box">
  <div class="section-left">
    <table border="0">
      ...
      <tr v-for="(item,index) in hiveList">
  ...
  <div class="section-right">
    <div class="detail-box">
      ...
      <div class="dtail-row">
        <div class="detail-col">
          蜂箱ID:
          <changeble-input :value="id" @change='idChange(id)'></changeble-input>
        </div>
        <div class="detail-col">
          出厂批次
        </div>
    ...
    <div class="chart-box">
      ...
      <div style="text-align:left;padding-left:20px;margin-top:10px;">
        <el-date-picker size='mini' v-model="date" @change="dateChange" value-format="yy-MM-dd" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
        </el-date-picker>
      </div>
